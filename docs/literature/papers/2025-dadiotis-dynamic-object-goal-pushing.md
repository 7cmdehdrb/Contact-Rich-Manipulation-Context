...
Actor observation은 $mathbf{o}_tinmathbb{R}^{54}$이다. Table I의 구성은 다음과 같다.
...
mathbf a_t=
left(
Deltamathbf u^{mathrm{cmd}}_{mathrm{base}},
Deltamathbf q^{mathrm{cmd}}_j
...
| Cardboard cylinder | 2.45 kg | $Phi30	imes40$ cm | 0° | — | 83.3% |

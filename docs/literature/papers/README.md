...
| [USER-P003](../reviews/user-found-papers.md#user-p003) | Sim-to-Real Transfer for Robotic Manipulation with Tactile Sensory | 제공된 IEEE 출판본 PDF 8쪽 전체 정독·정리 완료. 30-element binary tactile, TD3 observation/reward, domain randomization·bit flipping, zero-shot door-opening 실험, Limitation·Future Work 포함 | [2021 · Ding et al.](2021-ding-sim-to-real-tactile-manipulation.md) |
...
| [C1](../reviews/2026-09-16_binary-tactile-wrench-rl.md#c1) | Beyond Binary: Sim-to-Real Dexterous Manipulation with Physics-Grounded Contact Representation | 제공된 arXiv:2605.28812v1 PDF 18쪽 전체 정독·정리 완료. CoP taxel mapping·differentiable calibration·recurrent PPO·binary/raw-taxel ablation·zero-shot sim-to-real·Limitations/Future Work 포함 | [2026 · Pan et al.](2026-pan-beyond-binary-cop-tactile.md) |
...
| [ICRA 2024 후보 선별](../reviews/2026-09-19_icra-2024-contact-sensing-screening.md#icra24-yuan-robot-synesthesia) | Robot Synesthesia: In-Hand Manipulation with Visuotactile Sensing | 제공된 IEEE 출판본 PDF 8쪽 전체 정독·정리 완료. 16 FSR binary contact·tactile point cloud·camera/robot point-cloud fusion·PPO teacher→BC/DAgger student·real zero-shot ablation·Future Work·미명시 사항 포함 | [2024 · Yuan et al.](2024-yuan-robot-synesthesia-visuotactile.md) |
...
| 2026-09-20 | B008 / CHECK-A02 | Precision-Focused Reinforcement Learning Model for Robotic Object Pushing | 제공된 IEEE 출판본 PDF 8쪽 전체 정독·정리 완료. 14D vision-proprioception observation, full-episode GRU memory, SAC+HER, action-duration output, friction-force sampling, 1 cm reward, simulation/real evaluation, Limitation·Future Work 포함 | [2025 · Bergmann et al.](2025-bergmann-precision-focused-pushing.md) |
| 2026-09-20 | B057 / CHECK-A12 | Enhancing Tactile-based Reinforcement Learning for Robotic Control | 제공된 arXiv v1 / NeurIPS 2025 PDF 28쪽 전체 정독·정리 완료. sparse binary tactile, sensor/proprioception ablation, four SSL objectives, auxiliary memory, RoTO, representation analysis, simulation-only limitation·Future Work 포함 | [2025 · Miller et al.](2025-miller-enhancing-tactile-rl.md) |
| 2026-09-20 / 2026-09-21 재검증 | B007 / CHECK-A01 | Learning Force Control for Contact-Rich Manipulation Tasks With Rigid Position-Controlled Robots | 동일 SHA-256의 IEEE 출판본 PDF 8쪽 재검증 완료. EEF goal-error/F/T observation, SAC, parallel position-force/admittance controller, 8개 action-space 비교, fail-safe, safety-reward ablation, 실물 0.2/0.05 mm insertion, Limitation·Future Work 포함 | [2020 · Beltran-Hernandez et al.](2020-beltran-hernandez-learning-force-control.md) |

<a id="physical-parameter-followup"></a>

## Sweeping 물리 파라미터 적응 조사 후속 원문 정독

[2026-09-21 물리 파라미터 적응 조사](../reviews/2026-09-21_sweeping-physical-parameter-adaptation.md)에서 분류한 명시적 모델 추정 계열 중, 사용자가 원문 PDF를 제공하여 정식 상세 노트를 작성한 항목이다.
...
[2026-09-21 Wrist Wrench 조사](../reviews/2026-09-21_wrist-wrench-manipulation-survey.md)에서 정책 관측 또는 제어기·플래너 피드백 사례로 분류한 논문을 사용자가 원문 PDF로 제공하여 정식 상세 노트를 작성했다. 조사 논문의 reference chain에서 후속 확인한 문헌은 원래 W/C 후보와 섞지 않고 `연결 문헌`으로 구분한다.
...
| [C1](../reviews/2026-09-21_wrist-wrench-manipulation-survey.md#c1) | A Self-Tuning Impedance-Based Interaction Planner for Robotic Haptic Exploration | 제공된 arXiv:2203.05413v2 PDF 8쪽 전체 정독·렌더링 대조 완료. 내부 토크 기반 외력 추정, Exploration·Bouncing·FSM, 방향성 impedance·torque controller, 식 (1)–(9)·Algorithm 1–2·Fig. 1–9, 실물 high/low/self-tuning 비교, Limitation·Future Work·미명시 사항 포함. RL이 아닌 제어·계획 사례 | [2022 · Kato et al.](2022-kato-self-tuning-haptic-exploration.md) |
| [W5 Ref. 19 · 연결 문헌](../reviews/2026-09-21_wrist-wrench-manipulation-survey.md#ref-w5-19-lee-2019) | Making Sense of Vision and Touch: Self-Supervised Learning of Multimodal Representations for Contact-Rich Tasks | 제공된 IEEE ICRA 2019 출판본 PDF 8쪽 전체 정독·렌더링 대조 완료. 32×6 손목 F/T 이력·RGB·proprioception fusion, 세 self-supervised objective, frozen representation+TRPO, staged reward·compliant torque controller, modality ablation·형상 transfer, Future Work·미명시 사항 포함. 2022년 이후 선별 후보가 아닌 W5 Reference [19] 연결 문헌 | [2019 · Lee et al.](2019-lee-making-sense-vision-touch.md) |

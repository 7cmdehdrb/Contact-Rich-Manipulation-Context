...
| [Sweeping의 숨은 물리 조건에 대한 명시적 추정과 이력 기반 대응](2026-09-21_sweeping-physical-parameter-adaptation.md) | 2026-09-21 신규 조사, A1–A3·B1–B3·C1 | 명시적 물성·접촉 모델 추정, 정책 내부 이력+DR, 별도 latent 적응 구조를 비교. 이번 조사 대상은 상세 노트 미작성이며 보고서의 원문 근거·한계·Future Work를 참조 |

...
| [ICRA 2024 후보 논문 선별 — 축약 촉각 보완 구조와 F/T·촉각 역할 분담](2026-09-19_icra-2024-contact-sensing-screening.md) | 2026-09-19 조사, 사용자 제공 CSV 263개 레코드 | 제목·초록 기준 34편을 넓게 선별. 후속 원문 정독: [Unknown Object Retrieval](../papers/2024-zhao-unknown-object-retrieval.md) · [1 kHz Tactile Insertion](../papers/2024-wu-1khz-tactile-insertion.md). tactile partial observability·history, sparse Binary tactile, sensing reduction, force/haptic adaptation, object-state·privileged information과 비교군을 정리 |

...
각 조사 보고서의 상단에서 논문별 상세 노트로 이동할 수 있다. 아직 개별 노트가 없는 논문은 **상세 노트 미작성**으로 표시한다. 보고서 안의 요약·원문 확인과 개별 출판본 정독은 서로 다른 기록이다.
...
| [Binary Tactile·F/T 기반 RL](2026-09-16_binary-tactile-wrench-rl.md) | 2026-09-16 조사, B1–B4·W1–W4·C1 | [B1 · DexTouch](../papers/2024-lee-dextouch.md). 다른 항목은 보고서의 비교표·요약 참조 |

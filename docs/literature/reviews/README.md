...
| [Binary Tactile·F/T 기반 RL](2026-09-16_binary-tactile-wrench-rl.md) | 2026-09-16 조사, B1–B4·W1–W4·C1 | [B1 · DexTouch](../papers/2024-lee-dextouch.md) · [B3 · Rotating without Seeing](../papers/2023-yin-rotating-without-seeing.md) · [B4 · Enhancing Tactile RL](../papers/2025-miller-enhancing-tactile-rl.md) · [C1 · Beyond Binary](../papers/2026-pan-beyond-binary-cop-tactile.md). 다른 항목은 보고서의 비교표·요약 참조 |
...
| [ICRA 2024 후보 논문 선별 — 축약 촉각 보완 구조와 F/T·촉각 역할 분담](2026-09-19_icra-2024-contact-sensing-screening.md) | 2026-09-19 조사, 사용자 제공 CSV 263개 레코드 | 제목·초록 기준 34편을 넓게 선별. 후속 원문 정독: [Unknown Object Retrieval](../papers/2024-zhao-unknown-object-retrieval.md) · [1 kHz Tactile Insertion](../papers/2024-wu-1khz-tactile-insertion.md) · [Robot Synesthesia](../papers/2024-yuan-robot-synesthesia-visuotactile.md). tactile partial observability·history, sparse Binary tactile, sensing reduction, visuotactile spatial fusion, force/haptic adaptation, object-state·privileged information과 비교군을 정리 |
...
| [별도 확인 요청 논문 목록](2026-09-20_separate-review-paper-list.md) | 2026-09-20 사용자 지정, CHECK-A01–A24·CHECK-B01–B03 | `260918 Review Dataset`에서 별도로 확인할 27편. 사용자가 전달한 두 목록의 구분·순서를 유지하고 기존 Review 분석으로 연결. 후속 정식 상세 노트: [CHECK-A01 · Learning Force Control](../papers/2020-beltran-hernandez-learning-force-control.md) · [CHECK-A02 · Precision-Focused Pushing](../papers/2025-bergmann-precision-focused-pushing.md) · [CHECK-A12 · Enhancing Tactile RL](../papers/2025-miller-enhancing-tactile-rl.md) · [CHECK-A15 · Beyond Binary](../papers/2026-pan-beyond-binary-cop-tactile.md) · [CHECK-B02 · MAT](../papers/2019-wu-mat-adaptive-tactile-grasping.md) |
| [Sweeping의 숨은 물리 조건에 대한 명시적 추정과 이력 기반 대응](2026-09-21_sweeping-physical-parameter-adaptation.md) | 2026-09-21 신규 조사, A1–A3·B1–B3·C1 | 명시적 물성·접촉 모델 추정, 정책 내부 이력+DR, 별도 latent 적응 구조를 비교. 후속 원문 정독: [A2 · Haninger et al.](../papers/2024-haninger-differentiable-compliant-contact-primitives.md). 다른 항목은 보고서의 원문 근거·한계·Future Work를 참조 |
| [Wrist Wrench를 관측·피드백으로 사용하는 Manipulation 연구](2026-09-21_wrist-wrench-manipulation-survey.md) | 2026-09-21 신규 조사, W1–W7·C1–C2; RL 후속 R1–R8 | 외장·내장 F/T와 관절 토크 기반 추정을 구분하고 정책 관측 7편, 제어기·플래너 피드백 2편과 RL의 F/T 입력 사례 8편을 비교. 후속 원문 정독: [W1 · FoAR](../papers/2025-he-foar.md) · [W4 · Zero-Shot Transfer](../papers/2023-brahmbhatt-zero-shot-haptics-insertion.md) · [W7 · FORGE](../papers/2025-noseworthy-forge.md) · [C1 · Self-Tuning Planner](../papers/2022-kato-self-tuning-haptic-exploration.md). 선별 집계 밖 reference 연결: [W5 Ref. 19 · Lee et al. 2019](../papers/2019-lee-making-sense-vision-touch.md) |
| [RL 논문의 Reward Formulation 비교](2026-09-21_rl-reward-formulation-comparison.md) | 2026-09-22 갱신 기준 상세 노트 33편의 보상 전용 종합 | RL 보상 구조가 기록된 21편의 수식·가중치·조건·진전/접촉/안전 항을 비교. 원문 식과 해설, reward와 loss·constraint·termination을 구분하고 제외 12편의 사유를 기록 |
| [관련 연구 5축 비교·원문 근거](2026-09-22_related-work-five-axis-evidence.md) | 2026-09-22, 기존 상세 노트 33편의 관련 원문 재검증 | Observation·센서·Method·강건성·Sim-to-Real을 비교. [타임라인·Contribution 발표 초안](../../presentation/04_Related_Work_Timeline_and_Contributions.md)과 연결하며 실제 성과와 제안을 구분 |
...
논문 제목은 [전체 논문 색인](../papers/README.md)에서도 검색할 수 있다. R·IROS-S·B/W/C·CHECK·USER-P·T는 각 조사·목록에서 부여한 식별자이며, 새로운 논문 순위나 재분류가 아니다.

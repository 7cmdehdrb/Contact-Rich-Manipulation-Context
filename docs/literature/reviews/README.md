...
| [Research Motivation 보강: 물체 정보·축약 촉각](2026-09-18_reduced-tactile-object-information-survey.md) | 2026-09-18 조사, T1–T7. 실행 입력·학습 전용 정보·보완 근거 비교 | [DexTouch](../papers/2024-lee-dextouch.md) · [Rotating without Seeing](../papers/2023-yin-rotating-without-seeing.md) · [Tactile Pushing](../papers/2023-yang-sim-to-real-tactile-pushing.md) · [Sim2Real Tactile Manipulation](../papers/2024-su-sim2real-tactile-manipulation.md) · [Pushing in the Dark](../papers/2024-ozdamar-pushing-in-the-dark.md). RotateIt·AnyRotate: 상세 노트 미작성 |

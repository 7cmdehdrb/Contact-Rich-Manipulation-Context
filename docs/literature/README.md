...
공통 질문에 맞춘 독립 재분석 데이터셋은 [260918 Review Dataset](review_dataset/260918/README.md)에서 관리한다. [Batch 001: 1–15번](review_dataset/260918/batch_001/README.md), [Batch 002: 16–65번](review_dataset/260918/batch_002/README.md), [Batch 003: 66–106번](review_dataset/260918/batch_003/README.md)과 [전체 질문별 횡단 비교](review_dataset/260918/synthesis/literature-synthesis.md)가 작성되어 있다. `260918/`의 106개 PDF 전체 검토를 완료했으며 [test_pdfs 3편 검증본](review_dataset/260918/test_pdfs/README.md)은 전체 통계에서 제외한다. 이 데이터셋은 기존 개별 논문 노트와 별개다.
...
| 2026-09-19 | [ICRA 2024 후보 논문 선별 — 축약 촉각 보완 구조와 F/T·촉각 역할 분담](reviews/2026-09-19_icra-2024-contact-sensing-screening.md) | 사용자 제공 ICRA 2024 CSV 263개 레코드의 제목·초록을 검토하여 34편을 후속 정독 후보로 선별. tactile partial observability·history, sparse Binary tactile, sensing reduction, haptic/force 기반 물성 적응, object-state·privileged information과 vision-only 비교군을 구분한다. |
...
| 2026-09-20 | USER-P003 | [Tactile Sim-to-Real Door Opening — 30-element resistive array·binary contact·TD3·25D+30D observation·reward·domain randomization·bit flipping·zero-shot 실물 평가·한계/Future Work](papers/2021-ding-sim-to-real-tactile-manipulation.md) |
...
| 2026-09-21 | C1 | [Beyond Binary — CoP force+contact position·taxel mapping·differentiable calibration·GRU PPO·binary/raw-taxel ablation·zero-shot sim-to-real·한계/Future Work](papers/2026-pan-beyond-binary-cop-tactile.md) |
...
| 2026-09-21 | ICRA 2024 후보 선별 | [Robot Synesthesia — 16 FSR binary contact·tactile point cloud·camera/robot 3D fusion·privileged PPO teacher·BC/DAgger student·zero-shot 실물 ablation·Future Work](papers/2024-yuan-robot-synesthesia-visuotactile.md) |
...
| 2026-09-20 / 2026-09-21 재검증 | B007 / CHECK-A01 · 260918 Review Dataset 후속 | [Learning Force Control — filtered F/T·EEF goal error·SAC·parallel/admittance force control·action-space trade-off·fail-safe·safety reward·실물 precision insertion·한계/Future Work](papers/2020-beltran-hernandez-learning-force-control.md) |

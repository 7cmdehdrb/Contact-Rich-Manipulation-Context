...
| 2026-09-15 | [IROS 2023–2025 Tactile·F/T 기반 RL 관련 논문 제목 선별](reviews/2026-09-15_iros-2023-2025-tactile-force-torque-rl-title-screening.md) | 제공된 연도별 CSV의 제목 레코드 4,762건, 고유 제목 4,761개를 의미 기반으로 1차 선별했다. 엄격 일치와 원문 확인 후보를 구분하며, 센서 사용·RL 채택·성과는 원문 검증 전까지 미확정이다. |

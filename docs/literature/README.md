...
| 2026-09-18 | [Research Motivation 보강: 물체 정보 제공 조건과 축약 촉각의 보완 구조](reviews/2026-09-18_reduced-tactile-object-information-survey.md) | Sider Scholar 기반 2.1 조사 결과, T1–T7 비교. Pose·Shape의 실행 입력과 Critic·Reward·Teacher의 학습 전용 정보를 분리하고, 보완 근거·해석 범위·저자 명시 한계와 향후 방향을 정리한다. F/T 단독 한계 조사와 보상 설계는 범위 밖이다. |

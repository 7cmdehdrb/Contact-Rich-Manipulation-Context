...
| [02. Related Works](02_Related_Works.md) | F/T·Wrench 선행연구용 TODO, Tactile 선행연구, RL Reward Formulation, 항목별 DR 비교 |
...
Related Works의 F/T·Wrench 절은 TODO만 유지한다. RL은 지정한 7편의 Reward Formulation과 접촉·촉각 보상 조건을 정리하며, 별도의 정책 학습 개요는 두지 않는다. Method의 보상식은 여전히 미정이며, 사용자가 설계를 구체화한 뒤 보강한다.
